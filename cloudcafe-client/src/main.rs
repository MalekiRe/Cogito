...
use cloudcafe_common::packet::ServerStatus;
...
fn main() {
    ...
    let mut connection_manager = ConnectionManager::new(String::from("Malek"));
    ...
    sk.run(|sk| {
        ...
        if let Some(active_connection) = &connection_manager.connection {
